...
`,K=ne.forwardRef((m,l)=>{var c=m,{name:e,label:r,error:n,rows:t=4,required:a=!1}=c,o=C(c,["name","label","error","rows","required"]);return s(qi,{children:[i(se,{htmlFor:e,required:a,children:r}),n&&i(ji,{children:n}),i(Bi,d({id:e,name:e,rows:t,"aria-label":r,"aria-required":a,ref:l},o))]})}),Gi=u.div`
  display: flex;
  flex-direction: column;
  gap: 0.25rem;
`,Wi=u.p`
