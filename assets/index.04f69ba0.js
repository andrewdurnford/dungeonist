var Le=Object.defineProperty,ze=Object.defineProperties;var Ee=Object.getOwnPropertyDescriptors;var G=Object.getOwnPropertySymbols;var ue=Object.prototype.hasOwnProperty,me=Object.prototype.propertyIsEnumerable;var he=(e,r,a)=>r in e?Le(e,r,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[r]=a,d=(e,r)=>{for(var a in r||(r={}))ue.call(r,a)&&he(e,a,r[a]);if(G)for(var a of G(r))me.call(r,a)&&he(e,a,r[a]);return e},$=(e,r)=>ze(e,Ee(r));var C=(e,r)=>{var a={};for(var t in e)ue.call(e,t)&&r.indexOf(t)<0&&(a[t]=e[t]);if(e!=null&&G)for(var t of G(e))r.indexOf(t)<0&&me.call(e,t)&&(a[t]=e[t]);return a};import{j as ie,r as S,g as _,u as re,a as W,b as Te,s as u,L as H,c as Y,W as De,C as Re,R as ae,d as ne,e as q,f as U,o as te,N as Fe,h as N,O as Pe,i as Me,B as Ne,k as He,l as I,m as Ye,n as qe,p as Oe,A as je,I as Be,q as Ge,t as We,v as Ue,F as Qe}from"./vendor.67cf4be8.js";const Ve=function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerpolicy&&(o.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?o.credentials="include":n.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}};Ve();const i=ie.exports.jsx,s=ie.exports.jsxs,O=ie.exports.Fragment,pe=S.exports.createContext({});function Ke({children:e}){const[r,a]=S.exports.useState(null),[t,n]=S.exports.useState(localStorage.getItem("token"));function o({token:c,user:v}){a(v),n(c),localStorage.setItem("token",c)}function l(){a(null),n(null),localStorage.removeItem("token")}const m=S.exports.useMemo(()=>({user:r,token:t,isLoggedIn:!!t,login:o,logout:l}),[r,t,o,l]);return i(pe.Provider,{value:m,children:e})}function oe(){return S.exports.useContext(pe)}const z={},Je=_`
  ...
  signup(input: $input)
    ...
    `;function ri(e){const r=d(d({},z),e);return W(ii,r)}const ai=_`
  ...
  updateCharacterDetails(input: $input) {
    ...
    `;function fe(e){const r=d(d({},z),e);return W(ai,r)}const ni=_`
  ...
  character(id: $id) {
    ...
    `;function Q(e){const r=d(d({},z),e);return re(ni,r)}const ti=_`
    query Characters {
  characters {
    id
    name
...
`;function j(m){var c=m,{as:e="button",type:r="button",variant:a="primary",loading:t=!1,disabled:n=!1,children:o}=c,l=C(c,["as","type","variant","loading","disabled","children"]);return i(ui,$(d({as:e,type:e==="button"?r:void 0,$variant:a,disabled:t||n},l),{children:o&&t?i("div",{children:'"Loading..."'}):o}))}const mi=u.nav`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`;function b(n){var o=n,{size:e="16",weight:r="400",children:a}=o,t=C(o,["size","weight","children"]);return i($i,$(d({$size:e,$weight:r},t),{children:a}))}function B({message:e}){return s(A,{children:[i(b,{as:"h1",size:"32",children:"404"}),i(T,{children:e||"Not Found"}),i(H,{to:"/",children:"Home"})]})}const Ci=u.label`
  display: block;
  ...
  ${({$required:e})=>e&&Re`
    ...
    `};
`;function se(t){var n=t,{required:e=!1,children:r}=n,a=C(n,["required","children"]);return i(Ci,$(d({$required:e},a),{children:r}))}const ki=u.div`
  display: flex;
...
`,D=ae.forwardRef((m,l)=>{var c=m,{name:e,label:r,type:a,error:t,required:n=!1}=c,o=C(c,["name","label","type","error","required"]);return s(ki,{children:[i(se,{htmlFor:e,required:n,children:r}),t&&i(Si,{children:t}),i(_i,d({id:e,name:e,type:a,"aria-label":r,"aria-required":n,$error:!!t,ref:l},o))]})}),Ii=ne().shape({email:q().email("Must be a valid email").required("Email is required"),password:q().required("Password is required")});function Ai({loading:e,onSubmit:r}){var o,l;const{register:a,handleSubmit:t,formState:{errors:n}}=U({mode:"onTouched",resolver:te(Ii)});return i("form",{onSubmit:t(r),children:s(p,{direction:"column",gap:"16",children:[i(D,d({type:"text",label:"Email",placeholder:"example@gmail.com",error:(o=n.email)==null?void 0:o.message,required:!0},a("email"))),i(D,d({type:"password",label:"Password",error:(l=n.password)==null?void 0:l.message,required:!0},a("password"))),i(j,{type:"submit",loading:e,children:"Log in"})]})})}function Li(){const e=Y(),{login:r}=oe(),[a,{loading:t,error:n}]=ei({onError:o=>console.error(o),onCompleted:({login:o})=>{r(o),e("/")},update(o,{data:l}){o.modify({fields:{me(){return l==null?void 0:l.login.user}}})}});return s(A,{children:[i(b,{as:"h1",size:"32",children:"Log in"}),n&&s(T,{children:["Error: ",n.message]}),i(Ai,{loading:t,onSubmit:({email:o,password:l})=>a({variables:{input:{email:o,password:l}}})})]})}const zi=ne().shape({email:q().email("Must be a valid email").required("Email is required"),password:q().required("Password is required")});function Ei({loading:e,onSubmit:r}){var o,l;const{register:a,handleSubmit:t,formState:{errors:n}}=U({mode:"onTouched",resolver:te(zi)});return i("form",{onSubmit:t(r),children:s(p,{direction:"column",gap:"16",children:[i(D,d({type:"text",label:"Email",placeholder:"example@gmail.com",error:(o=n.email)==null?void 0:o.message,required:!0},a("email"))),i(D,d({type:"password",label:"Password",error:(l=n.password)==null?void 0:l.message,required:!0},a("password"))),i(j,{type:"submit",loading:e,children:"Sign up"})]})})}function Ti(){const e=Y(),[r,{loading:a,error:t}]=ri({onError:n=>console.error(n),onCompleted:()=>e("/")});return s(A,{children:[i(b,{as:"h1",size:"32",children:"Sign up"}),t&&s(T,{children:["Error: ",t.message]}),i(Ei,{loading:a,onSubmit:({email:n,password:o})=>r({variables:{input:{email:n,password:o}}})})]})}function le(){return i(A,{children:i("p",{children:"Loading..."})})}const Di=u.ul`
  margin-left: 2rem;
`;function Ri(){const{data:e,loading:r,error:a}=oi(),[t,{loading:n,error:o}]=Xe({onError:l=>console.error(l),update(l,{data:m}){l.modify({fields:{characters(c=[]){const v=l.writeFragment({data:m==null?void 0:m.createCharacter.character,fragment:_`
                  fragment NewCharacter on Character {
                    id
                    name
                  }
                `});return[...c,v]}}})}});return r?i(le,{}):a||!e?s(T,{children:["Error: ",a&&a.message]}):s(A,{children:[i(b,{as:"h1",size:"32",children:"Characters"}),o&&s(T,{children:["Error: ",o==null?void 0:o.message]}),i(Di,{children:e.characters.map(({id:l,name:m})=>i("li",{children:i(H,{to:`/characters/${l}`,children:m})},l))})]})}const we="active",$e=u(b).attrs({forwardedAs:H})`
  display: inline-block;
...
`,Ce=a=>{var t=a,{children:e}=t,r=C(t,["children"]);return i($e,$(d({},r),{children:e}))},Pi=a=>{var t=a,{children:e}=t,r=C(t,["children"]);return i(Fi,$(d({className:({isActive:n})=>n?we:""},r),{children:e}))},ce=u(Pi)`
  padding: 11.5px 16px;
...
`,K=ae.forwardRef((m,l)=>{var c=m,{name:e,label:r,error:a,rows:t=4,required:n=!1}=c,o=C(c,["name","label","error","rows","required"]);return s(Oi,{children:[i(se,{htmlFor:e,required:n,children:r}),a&&i(ji,{children:a}),i(Bi,d({id:e,name:e,rows:t,"aria-label":r,"aria-required":n,ref:l},o))]})}),Gi=u.div`
  display: flex;
  flex-direction: column;
  gap: 0.25rem;
`,Wi=u.p`
...
`,Ui=u.select`
  ...
  line-height: inherit;
  text-decoration: inherit;
`,ke=ae.forwardRef((m,l)=>{var c=m,{name:e,label:r,error:a,required:t=!1,children:n}=c,o=C(c,["name","label","error","required","children"]);return s(Gi,{children:[i(se,{htmlFor:e,required:t,children:r}),a&&i(Wi,{children:a}),i(Ui,$(d({id:e,name:e,"aria-label":r,"aria-required":t,$error:!!a,ref:l},o),{children:n}))]})});function Se({name:e,loading:r,onReset:a}){return s(p,{alignItems:"center",children:[i(b,{as:"h1",size:"32",children:e}),s(ve,{justifyContent:"flex-end",gap:"4",children:[i(j,{type:"submit",loading:r,children:"Save"}),i(j,{variant:"secondary",onClick:a,children:"Reset"})]})]})}const Qi=ne().shape({name:q(),level:Me().typeError("Level must be between 1 and 20").integer("Level must be between 1 and 20").strict().min(1,"Level must be between 1 and 20").max(20,"Level must be between 1 and 20")});function Vi({name:e,level:r,alignmentId:a,background:t,traits:n,ideals:o,bonds:l,flaws:m,loading:c,onCancel:v,onSubmit:L}){var w,h,x,k,R,F,P,M;const{register:f,handleSubmit:E,formState:{errors:g}}=U({mode:"onTouched",defaultValues:{name:e,level:r,alignmentId:a,background:t,traits:n,ideals:o,bonds:l,flaws:m},resolver:te(Qi)});return i("form",{onSubmit:E(L),children:s(p,{direction:"column",gap:"16",children:[i(Se,{name:"Details",loading:c,onReset:v}),s(p,{gap:"16",justifyContent:"center",children:[s(p,{as:"section",direction:"column",gap:"16",flexGrow:1,children:[i(D,d({type:"text",label:"Name",placeholder:"Untitled",error:(w=g.name)==null?void 0:w.message},f("name"))),i(D,d({type:"number",label:"Level",error:(h=g.level)==null?void 0:h.message},f("level",{valueAsNumber:!0}))),i(D,d({type:"text",label:"Background",placeholder:"Acolyte",error:(x=g.background)==null?void 0:x.message},f("background"))),s(ke,$(d({label:"Alignment",error:(k=g.alignmentId)==null?void 0:k.message},f("alignmentId")),{children:[i("option",{value:"",selected:!0,disabled:!0}),i("option",{value:"1",children:"Lawful Good"}),i("option",{value:"2",children:"Neutral Good"}),i("option",{value:"3",children:"Chaotic Good"}),i("option",{value:"4",children:"Lawful Neutral"}),i("option",{value:"5",children:"Neutral"}),i("option",{value:"6",children:"Chaotic Neutral"}),i("option",{value:"7",children:"Lawful Evil"}),i("option",{value:"8",children:"Neutral Evil"}),i("option",{value:"9",children:"Chaotic Evil"})]}))]}),s(p,{as:"section",direction:"column",gap:"16",flexGrow:1,children:[i(K,d({label:"Personality traits",error:(R=g.traits)==null?void 0:R.message},f("traits"))),i(K,d({label:"Ideals",error:(F=g.ideals)==null?void 0:F.message},f("ideals"))),i(K,d({label:"Bonds",error:(P=g.bonds)==null?void 0:P.message},f("bonds"))),i(K,d({label:"Flaws",error:(M=g.flaws)==null?void 0:M.message},f("flaws")))]})]})]})})}function Ki(){var v,L,f,E,g,w,h;const e=Y(),{characterId:r}=N(),{data:a,loading:t,error:n}=Q({variables:{id:String(r)}}),[o,{loading:l,error:m}]=fe({onError:x=>console.error(x)});if(n||!(a==null?void 0:a.character))return i(B,{message:n==null?void 0:n.message});const{character:c}=a;return s(A,{children:[m&&i(T,{children:m.message}),i(Vi,{name:c.name,level:c.level,alignmentId:(L=(v=c.alignment)==null?void 0:v.id)!=null?L:"",background:(f=c.background)!=null?f:"",traits:(E=c.traits)!=null?E:"",ideals:(g=c.ideals)!=null?g:"",bonds:(w=c.bonds)!=null?w:"",flaws:(h=c.flaws)!=null?h:"",loading:l,onCancel:()=>e(`/characters/${r}`),onSubmit:({name:x,level:k,background:R,alignmentId:F,traits:P,ideals:M,bonds:Z,flaws:ee})=>{o({variables:{input:{id:String(r),name:x||void 0,level:k||void 0,background:R||void 0,alignmentId:F||void 0,traits:P||void 0,ideals:M||void 0,bonds:Z||void 0,flaws:ee||void 0}}}),e(`/characters/${r}`)}})]})}const Ji=u.ul`
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  justify-content: space-between;
...
`,er=u.h3`
  font-size: 24px;
  line-height: 32px;
`;function ir({ability:e}){const{id:r,name:a,score:t,modifier:n}=e;return s(Xi,{children:[i(Zi,{children:a.slice(0,3)}),s(er,{children:[n>=0?"+":"-",n]}),i("span",{children:t})]},r)}function rr({abilities:e}){return s(p,{as:"section",direction:"column",gap:"16",children:[i(b,{as:"h3",weight:"600",children:"Abilities"}),i(Ji,{children:e.map(r=>i(ir,{ability:r}))})]})}const ar=u.ul`
  margin-left: 1.5rem;
`,nr=u.li`
