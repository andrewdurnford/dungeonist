var ze=Object.defineProperty,Ee=Object.defineProperties;var Te=Object.getOwnPropertyDescriptors;var W=Object.getOwnPropertySymbols;var ue=Object.prototype.hasOwnProperty,me=Object.prototype.propertyIsEnumerable;var he=(e,r,a)=>r in e?ze(e,r,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[r]=a,d=(e,r)=>{for(var a in r||(r={}))ue.call(r,a)&&he(e,a,r[a]);if(W)for(var a of W(r))me.call(r,a)&&he(e,a,r[a]);return e},$=(e,r)=>Ee(e,Te(r));var C=(e,r)=>{var a={};for(var t in e)ue.call(e,t)&&r.indexOf(t)<0&&(a[t]=e[t]);if(e!=null&&W)for(var t of W(e))r.indexOf(t)<0&&me.call(e,t)&&(a[t]=e[t]);return a};import{j as ae,r as S,g as _,u as ne,a as U,b as De,s as u,L as q,c as O,W as Fe,C as Re,R as te,d as Q,e as N,f as j,o as V,h as pe,N as Pe,i as H,O as Me,B as Ne,k as He,l as I,m as Ye,n as qe,p as Oe,A as je,I as Be,q as Ge,t as We,v as Ue,F as Qe}from"./vendor.2be2c6d8.js";const Ve=function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerpolicy&&(o.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?o.credentials="include":n.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}};Ve();const i=ae.exports.jsx,s=ae.exports.jsxs,B=ae.exports.Fragment,fe=S.exports.createContext({});function Ke({children:e}){const[r,a]=S.exports.useState(null),[t,n]=S.exports.useState(localStorage.getItem("token"));function o({token:c,user:v}){a(v),n(c),localStorage.setItem("token",c)}function l(){a(null),n(null),localStorage.removeItem("token")}const m=S.exports.useMemo(()=>({user:r,token:t,isLoggedIn:!!t,login:o,logout:l}),[r,t,o,l]);return i(fe.Provider,{value:m,children:e})}function oe(){return S.exports.useContext(fe)}const E={},Je=_`
  ...
  signup(input: $input)
    ...
    `;function ri(e){const r=d(d({},E),e);return U(ii,r)}const ai=_`
  ...
  updateCharacterDetails(input: $input) {
    ...
    `;function ge(e){const r=d(d({},E),e);return U(ai,r)}const ni=_`
  ...
  character(id: $id) {
    ...
    `;function K(e){const r=d(d({},E),e);return ne(ni,r)}const ti=_`
    query Characters {
  characters {
    id
    name
    ...
    `;function oi(e){const r=d(d({},E),e);return ne(ti,r)}const li=_`
    query Me {
  me {
    id
    email
    ...
    `;function si(e){const r=d(d({},E),e);return ne(li,r)}const ci=_`
    query Race($id: ID!) {
  race(id: $id) {
    id
    name
...
`;function Y(m){var c=m,{as:e="button",type:r="button",variant:a="primary",loading:t=!1,disabled:n=!1,children:o}=c,l=C(c,["as","type","variant","loading","disabled","children"]);return i(ui,$(d({as:e,type:e==="button"?r:void 0,$variant:a,disabled:t||n},l),{children:o&&t?i("div",{children:'"Loading..."'}):o}))}const mi=u.nav`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`;function y(n){var o=n,{size:e="16",weight:r="400",children:a}=o,t=C(o,["size","weight","children"]);return i($i,$(d({$size:e,$weight:r},t),{children:a}))}function G({message:e}){return s(A,{children:[i(y,{as:"h1",size:"32",children:"404"}),i(D,{children:e||"Not Found"}),i(q,{to:"/",children:"Home"})]})}const Ci=u.label`
  display: block;
  ...
  ${({$required:e})=>e&&Re`
    ...
    `};
`;function le(t){var n=t,{required:e=!1,children:r}=n,a=C(n,["required","children"]);return i(Ci,$(d({$required:e},a),{children:r}))}const ki=u.div`
  display: flex;
...
`,L=te.forwardRef((m,l)=>{var c=m,{name:e,label:r,type:a,error:t,required:n=!1}=c,o=C(c,["name","label","type","error","required"]);return s(ki,{children:[i(le,{htmlFor:e,required:n,children:r}),t&&i(Si,{children:t}),i(_i,d({id:e,name:e,type:a,"aria-label":r,"aria-required":n,$error:!!t,ref:l},o))]})}),Ii=Q().shape({email:N().email("Must be a valid email").required("Email is required"),password:N().required("Password is required")});function Ai({loading:e,onSubmit:r}){var o,l;const{register:a,handleSubmit:t,formState:{errors:n}}=j({mode:"onTouched",resolver:V(Ii)});return i("form",{onSubmit:t(r),children:s(p,{direction:"column",gap:"16",children:[i(L,d({type:"text",label:"Email",placeholder:"example@gmail.com",error:(o=n.email)==null?void 0:o.message,required:!0},a("email"))),i(L,d({type:"password",label:"Password",error:(l=n.password)==null?void 0:l.message,required:!0},a("password"))),i(Y,{type:"submit",loading:e,children:"Log in"})]})})}function Li(){const e=O(),{login:r}=oe(),[a,{loading:t,error:n}]=ei({onError:o=>console.error(o),onCompleted:({login:o})=>{r(o),e("/")},update(o,{data:l}){o.modify({fields:{me(){return l==null?void 0:l.login.user}}})}});return s(A,{children:[i(y,{as:"h1",size:"32",children:"Log in"}),n&&s(D,{children:["Error: ",n.message]}),i(Ai,{loading:t,onSubmit:({email:o,password:l})=>a({variables:{input:{email:o,password:l}}})})]})}const zi=Q().shape({email:N().email("Must be a valid email").required("Email is required"),password:N().required("Password is required")});function Ei({loading:e,onSubmit:r}){var o,l;const{register:a,handleSubmit:t,formState:{errors:n}}=j({mode:"onTouched",resolver:V(zi)});return i("form",{onSubmit:t(r),children:s(p,{direction:"column",gap:"16",children:[i(L,d({type:"text",label:"Email",placeholder:"example@gmail.com",error:(o=n.email)==null?void 0:o.message,required:!0},a("email"))),i(L,d({type:"password",label:"Password",error:(l=n.password)==null?void 0:l.message,required:!0},a("password"))),i(Y,{type:"submit",loading:e,children:"Sign up"})]})})}function Ti(){const e=O(),[r,{loading:a,error:t}]=ri({onError:n=>console.error(n),onCompleted:()=>e("/")});return s(A,{children:[i(y,{as:"h1",size:"32",children:"Sign up"}),t&&s(D,{children:["Error: ",t.message]}),i(Ei,{loading:a,onSubmit:({email:n,password:o})=>r({variables:{input:{email:n,password:o}}})})]})}function se(){return i(A,{children:i("p",{children:"Loading..."})})}const Di=Q().shape({name:N(),level:pe().typeError("Level must be between 1 and 20").integer("Level must be between 1 and 20").strict().min(1,"Level must be between 1 and 20").max(20,"Level must be between 1 and 20")});function Fi({loading:e,onSubmit:r}){var o,l;const{register:a,handleSubmit:t,formState:{errors:n}}=j({mode:"onTouched",defaultValues:{level:1},resolver:V(Di)});return i("form",{onSubmit:t(r),children:s(p,{direction:"column",gap:"16",children:[i(L,d({type:"text",label:"Name",placeholder:"Untitled",error:(o=n.name)==null?void 0:o.message},a("name"))),i(L,d({type:"number",label:"Level",error:(l=n.level)==null?void 0:l.message},a("level",{valueAsNumber:!0}))),i(Y,{type:"submit",loading:e,children:"Create"})]})})}const Ri=u.ul`
  margin-left: 2rem;
`;function Pi(){const{data:e,loading:r,error:a}=oi(),[t,{loading:n,error:o}]=Xe({onError:l=>console.error(l),update(l,{data:m}){l.modify({fields:{characters(c=[]){const v=l.writeFragment({data:m==null?void 0:m.createCharacter.character,fragment:_`
                  fragment NewCharacter on Character {
                    id
                    name
                  }
                `});return[...c,v]}}})}});return r?i(se,{}):a||!e?s(D,{children:["Error: ",a&&a.message]}):s(A,{children:[i(y,{as:"h1",size:"32",children:"Characters"}),o&&s(D,{children:["Error: ",o==null?void 0:o.message]}),i(Fi,{loading:n,onSubmit:({name:l,level:m})=>t({variables:{input:{name:l||void 0,level:m||void 0}}})}),i(Ri,{children:e.characters.map(({id:l,name:m})=>i("li",{children:i(q,{to:`/characters/${l}`,children:m})},l))})]})}const $e="active",Ce=u(y).attrs({forwardedAs:q})`
  display: inline-block;
...
`,ke=a=>{var t=a,{children:e}=t,r=C(t,["children"]);return i(Ce,$(d({},r),{children:e}))},Ni=a=>{var t=a,{children:e}=t,r=C(t,["children"]);return i(Mi,$(d({className:({isActive:n})=>n?$e:""},r),{children:e}))},ce=u(Ni)`
  padding: 11.5px 16px;
...
`,X=te.forwardRef((m,l)=>{var c=m,{name:e,label:r,error:a,rows:t=4,required:n=!1}=c,o=C(c,["name","label","error","rows","required"]);return s(Bi,{children:[i(le,{htmlFor:e,required:n,children:r}),a&&i(Gi,{children:a}),i(Wi,d({id:e,name:e,rows:t,"aria-label":r,"aria-required":n,ref:l},o))]})}),Ui=u.div`
  display: flex;
  flex-direction: column;
  gap: 0.25rem;
`,Qi=u.p`
...
`,Vi=u.select`
  ...
  line-height: inherit;
  text-decoration: inherit;
`,Se=te.forwardRef((m,l)=>{var c=m,{name:e,label:r,error:a,required:t=!1,children:n}=c,o=C(c,["name","label","error","required","children"]);return s(Ui,{children:[i(le,{htmlFor:e,required:t,children:r}),a&&i(Qi,{children:a}),i(Vi,$(d({id:e,name:e,"aria-label":r,"aria-required":t,$error:!!a,ref:l},o),{children:n}))]})});function _e({name:e,loading:r,onReset:a}){return s(p,{alignItems:"center",children:[i(y,{as:"h1",size:"32",children:e}),s(xe,{justifyContent:"flex-end",gap:"4",children:[i(Y,{type:"submit",loading:r,children:"Save"}),i(Y,{variant:"secondary",onClick:a,children:"Reset"})]})]})}const Ki=Q().shape({name:N(),level:pe().typeError("Level must be between 1 and 20").integer("Level must be between 1 and 20").strict().min(1,"Level must be between 1 and 20").max(20,"Level must be between 1 and 20")});function Ji({name:e,level:r,alignmentId:a,background:t,traits:n,ideals:o,bonds:l,flaws:m,loading:c,onCancel:v,onSubmit:z}){var w,h,x,k,F,R,P,M;const{register:f,handleSubmit:T,formState:{errors:g}}=j({mode:"onTouched",defaultValues:{name:e,level:r,alignmentId:a,background:t,traits:n,ideals:o,bonds:l,flaws:m},resolver:V(Ki)});return i("form",{onSubmit:T(z),children:s(p,{direction:"column",gap:"16",children:[i(_e,{name:"Details",loading:c,onReset:v}),s(p,{gap:"16",justifyContent:"center",children:[s(p,{as:"section",direction:"column",gap:"16",flexGrow:1,children:[i(L,d({type:"text",label:"Name",placeholder:"Untitled",error:(w=g.name)==null?void 0:w.message},f("name"))),i(L,d({type:"number",label:"Level",error:(h=g.level)==null?void 0:h.message},f("level",{valueAsNumber:!0}))),i(L,d({type:"text",label:"Background",placeholder:"Acolyte",error:(x=g.background)==null?void 0:x.message},f("background"))),s(Se,$(d({label:"Alignment",error:(k=g.alignmentId)==null?void 0:k.message},f("alignmentId")),{children:[i("option",{value:"",selected:!0,disabled:!0}),i("option",{value:"1",children:"Lawful Good"}),i("option",{value:"2",children:"Neutral Good"}),i("option",{value:"3",children:"Chaotic Good"}),i("option",{value:"4",children:"Lawful Neutral"}),i("option",{value:"5",children:"Neutral"}),i("option",{value:"6",children:"Chaotic Neutral"}),i("option",{value:"7",children:"Lawful Evil"}),i("option",{value:"8",children:"Neutral Evil"}),i("option",{value:"9",children:"Chaotic Evil"})]}))]}),s(p,{as:"section",direction:"column",gap:"16",flexGrow:1,children:[i(X,d({label:"Personality traits",error:(F=g.traits)==null?void 0:F.message},f("traits"))),i(X,d({label:"Ideals",error:(R=g.ideals)==null?void 0:R.message},f("ideals"))),i(X,d({label:"Bonds",error:(P=g.bonds)==null?void 0:P.message},f("bonds"))),i(X,d({label:"Flaws",error:(M=g.flaws)==null?void 0:M.message},f("flaws")))]})]})]})})}function Xi(){var v,z,f,T,g,w,h;const e=O(),{characterId:r}=H(),{data:a,loading:t,error:n}=K({variables:{id:String(r)}}),[o,{loading:l,error:m}]=ge({onError:x=>console.error(x)});if(n||!(a==null?void 0:a.character))return i(G,{message:n==null?void 0:n.message});const{character:c}=a;return s(A,{children:[m&&i(D,{children:m.message}),i(Ji,{name:c.name,level:c.level,alignmentId:(z=(v=c.alignment)==null?void 0:v.id)!=null?z:"",background:(f=c.background)!=null?f:"",traits:(T=c.traits)!=null?T:"",ideals:(g=c.ideals)!=null?g:"",bonds:(w=c.bonds)!=null?w:"",flaws:(h=c.flaws)!=null?h:"",loading:l,onCancel:()=>e(`/characters/${r}`),onSubmit:({name:x,level:k,background:F,alignmentId:R,traits:P,ideals:M,bonds:ie,flaws:re})=>{o({variables:{input:{id:String(r),name:x||void 0,level:k||void 0,background:F||void 0,alignmentId:R||void 0,traits:P||void 0,ideals:M||void 0,bonds:ie||void 0,flaws:re||void 0}}}),e(`/characters/${r}`)}})]})}const Zi=u.ul`
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  justify-content: space-between;
...
`,rr=u.h3`
  font-size: 24px;
  line-height: 32px;
`;function ar({ability:e}){const{id:r,name:a,score:t,modifier:n}=e;return s(er,{children:[i(ir,{children:a.slice(0,3)}),s(rr,{children:[n>=0?"+":"-",n]}),i("span",{children:t})]},r)}function nr({abilities:e}){return s(p,{as:"section",direction:"column",gap:"16",children:[i(y,{as:"h3",weight:"600",children:"Abilities"}),i(Zi,{children:e.map(r=>i(ar,{ability:r}))})]})}const tr=u.ul`
  margin-left: 1.5rem;
`,or=u.li`
