...
`,N={black:"#000000",white:"#FFFFFF",blue400:"#60A5FA",blue500:"#3B82F6",blue600:"#2563EB",gray100:"#F3F4F6",gray200:"#E5E7EB",gray500:"#9CA3AF",gray600:"#4B5563",gray700:"#374151",red50:"#FEF2F2",red200:"#FECACA",red400:"#F87171",red500:"#EF4444"},we={sm:640,md:768,lg:1024,xl:1280},Le={colors:N,breakpoints:we},r=B.exports.jsx,l=B.exports.jsxs,j=B.exports.Fragment;function Se(e){if(e!=="none")return`${e}px`}function m(e){if(e!=="none")return e==="auto"?"auto":`${e}px`}const Ee=f.div`
  /* flex parent */
  display: flex;
...
`;function E({as:e="button",type:n="button",variant:t="primary",loading:a=!1,disabled:i=!1,children:s,...o}){return r(ze,{as:e,type:e==="button"?n:void 0,$variant:t,disabled:a||i,...o,children:s&&a?r("div",{children:"Loading..."}):s})}const Me=_().shape({email:L().email("Must be a valid email").required("Email is required"),password:L().required("Password is required")});function Be({loading:e,onSubmit:n}){const{register:t,handleSubmit:a,formState:{errors:i}}=D({mode:"onTouched",resolver:O(Me)});return r("form",{onSubmit:a(n),children:l(A,{direction:"column",gap:"16",children:[r(z,{type:"text",label:"Email",placeholder:"example@gmail.com",error:i.email?.message,required:!0,...t("email")}),r(z,{type:"password",label:"Password",error:i.password?.message,required:!0,...t("password")}),r(E,{type:"submit",loading:e,children:"Log in"})]})})}const W=y.exports.createContext({});function Oe({children:e}){const[n,t]=y.exports.useState(null),[a,i]=y.exports.useState(localStorage.getItem("token"));function s({token:d,user:h}){t(h),i(d),localStorage.setItem("token",d)}function o(){t(null),i(null),localStorage.removeItem("token")}const c=y.exports.useMemo(()=>({user:n,token:a,isLoggedIn:!!a,login:s,logout:o}),[n,a,s,o]);return r(W.Provider,{value:c,children:e})}function H(){return y.exports.useContext(W)}const x={},Te=p`
  ...
  updateCharacterDetails(input: $input) {
    ...
    `;function Q(e){const n={...x,...e};return q(Ve,n)}const Ge=p`
    query Alignments {
  alignments {
    id
    name
  ...
  races {
    ...
    `;function nr(e){const n={...x,...e};return R(rr,n)}function tr(){const e=T(),{login:n}=H(),[t,{loading:a,error:i}]=We({onError:s=>console.error(s),onCompleted:({login:s})=>{n(s),e("/")},update(s,{data:o}){s.modify({fields:{me(){return o?.login.user}}})}});return l(S,{children:[r(P,{as:"h1",size:"32",children:"Log in"}),i&&l(b,{children:["Error: ",i.message]}),r(Be,{loading:a,onSubmit:({email:s,password:o})=>t({variables:{input:{email:s,password:o}}})})]})}const ir=_().shape({email:L().email("Must be a valid email").required("Email is required"),password:L().required("Password is required")});function ar({loading:e,onSubmit:n}){const{register:t,handleSubmit:a,formState:{errors:i}}=D({mode:"onTouched",resolver:O(ir)});return r("form",{onSubmit:a(n),children:l(A,{direction:"column",gap:"16",children:[r(z,{type:"text",label:"Email",placeholder:"example@gmail.com",error:i.email?.message,required:!0,...t("email")}),r(z,{type:"password",label:"Password",error:i.password?.message,required:!0,...t("password")}),r(E,{type:"submit",loading:e,children:"Sign up"})]})})}function or(){const e=T(),[n,{loading:t,error:a}]=Qe({onError:i=>console.error(i),onCompleted:()=>e("/")});return l(S,{children:[r(P,{as:"h1",size:"32",children:"Sign up"}),a&&l(b,{children:["Error: ",a.message]}),r(ar,{loading:t,onSubmit:({email:i,password:s})=>n({variables:{input:{email:i,password:s}}})})]})}function sr(){return r(S,{children:r("p",{children:"Loading..."})})}_().shape({name:L(),level:U().typeError("Level must be between 1 and 20").integer("Level must be between 1 and 20").strict().min(1,"Level must be between 1 and 20").max(20,"Level must be between 1 and 20")});const lr=f.ul`
  margin-left: 2rem;
