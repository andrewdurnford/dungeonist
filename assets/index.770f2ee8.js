var ze=Object.defineProperty,Ee=Object.defineProperties;var De=Object.getOwnPropertyDescriptors;var K=Object.getOwnPropertySymbols;var fe=Object.prototype.hasOwnProperty,ge=Object.prototype.propertyIsEnumerable;var pe=(e,i,a)=>i in e?ze(e,i,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[i]=a,c=(e,i)=>{for(var a in i||(i={}))fe.call(i,a)&&pe(e,a,i[a]);if(K)for(var a of K(i))ge.call(i,a)&&pe(e,a,i[a]);return e},S=(e,i)=>Ee(e,De(i));var _=(e,i)=>{var a={};for(var t in e)fe.call(e,t)&&i.indexOf(t)<0&&(a[t]=e[t]);if(e!=null&&K)for(var t of K(e))i.indexOf(t)<0&&ge.call(e,t)&&(a[t]=e[t]);return a};import{j as oe,r as L,g as C,u as j,a as J,b as Re,s as d,L as B,c as G,W as Te,C as Fe,R as se,d as le,e as W,f as X,o as ce,N as Pe,h as q,O as Me,i as Ne,B as He,k as qe,l as z,m as Ye,n as Oe,p as je,A as Be,I as Ge,q as We,t as Qe,v as Ue,F as Ve}from"./vendor.67cf4be8.js";const Ke=function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerpolicy&&(o.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?o.credentials="include":n.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}};Ke();const r=oe.exports.jsx,s=oe.exports.jsxs,Q=oe.exports.Fragment,ye=L.exports.createContext({});function Je({children:e}){const[i,a]=L.exports.useState(null),[t,n]=L.exports.useState(localStorage.getItem("token"));function o({token:m,user:y}){a(y),n(m),localStorage.setItem("token",m)}function l(){a(null),n(null),localStorage.removeItem("token")}const h=L.exports.useMemo(()=>({user:i,token:t,isLoggedIn:!!t,login:o,logout:l}),[i,t,o,l]);return r(ye.Provider,{value:h,children:e})}function de(){return L.exports.useContext(ye)}const A={},Xe=C`
  ...
  races {
    ...
    `;function gi(e){const i=c(c({},A),e);return j(fi,i)}const pi=d.button`
...
`;function U(h){var m=h,{as:e="button",type:i="button",variant:a="primary",loading:t=!1,disabled:n=!1,children:o}=m,l=_(m,["as","type","variant","loading","disabled","children"]);return r(pi,S(c({as:e,type:e==="button"?i:void 0,$variant:a,disabled:t||n},l),{children:o&&t?r("div",{children:'"Loading..."'}):o}))}const yi=d.nav`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`;function g(kr){var he=kr,{direction:e="row",wrap:i="nowrap",justifyContent:a="flex-start",alignItems:t="stretch",alignContent:n="normal",gap:o="none",flexGrow:l=0,flexShrink:h=1,flexBasis:m="auto",alignSelf:y="auto",m:w="none",mx:u="none",my:b="none",mt:D="none",mr:p="none",mb:R="none",ml:T="none",p:k="none",px:f="none",py:$="none",pt:I="none",pr:M="none",pb:N="none",pl:H="none",background:O,children:ne}=he,te=_(he,["direction","wrap","justifyContent","alignItems","alignContent","gap","flexGrow","flexShrink","flexBasis","alignSelf","m","mx","my","mt","mr","mb","ml","p","px","py","pt","pr","pb","pl","background","children"]);return r(ki,S(c({$flexDirection:e,$flexWrap:i,$justifyContent:a,$alignItems:t,$gap:o,$flexGrow:l,$flexShrink:h,$flexBasis:m,$alignSelf:y,$m:w,$mx:u,$my:b,$mt:D,$mr:p,$mb:R,$ml:T,$p:k,$px:f,$py:$,$pt:I,$pr:M,$pb:N,$pl:H,$background:O},te),{children:ne}))}const $e=d(g)`
  max-width: 100%;
`;function E({children:e}){return r(g,{as:"main",direction:"column",gap:"16",mx:"auto",p:"32",children:e})}function Ce({children:e}){return r(g,{direction:"column",gap:"16",flexGrow:1,children:e})}function Si(){return r(E,{children:r("h1",{children:"Hello World"})})}const _i=d.div`
  display: inline-block;
  border-radius: 4px;
  padding: 3px 8px;
...
`,P=se.forwardRef((h,l)=>{var m=h,{name:e,label:i,type:a,error:t,required:n=!1}=m,o=_(m,["name","label","type","error","required"]);return s(Li,{children:[r(ue,{htmlFor:e,required:n,children:i}),t&&r(zi,{children:t}),r(Ei,c({id:e,name:e,type:a,"aria-label":i,"aria-required":n,$error:!!t,ref:l},o))]})}),Di=le().shape({email:W().email("Must be a valid email").required("Email is required"),password:W().required("Password is required")});function Ri({loading:e,onSubmit:i}){var o,l;const{register:a,handleSubmit:t,formState:{errors:n}}=X({mode:"onTouched",resolver:ce(Di)});return r("form",{onSubmit:t(i),children:s(g,{direction:"column",gap:"16",children:[r(P,c({type:"text",label:"Email",placeholder:"example@gmail.com",error:(o=n.email)==null?void 0:o.message,required:!0},a("email"))),r(P,c({type:"password",label:"Password",error:(l=n.password)==null?void 0:l.message,required:!0},a("password"))),r(U,{type:"submit",loading:e,children:"Log in"})]})})}function Ti(){const e=G(),{login:i}=de(),[a,{loading:t,error:n}]=ii({onError:o=>console.error(o),onCompleted:({login:o})=>{i(o),e("/")},update(o,{data:l}){o.modify({fields:{me(){return l==null?void 0:l.login.user}}})}});return s(E,{children:[r(x,{as:"h1",size:"32",children:"Log in"}),n&&s(F,{children:["Error: ",n.message]}),r(Ri,{loading:t,onSubmit:({email:o,password:l})=>a({variables:{input:{email:o,password:l}}})})]})}const Fi=le().shape({email:W().email("Must be a valid email").required("Email is required"),password:W().required("Password is required")});function Pi({loading:e,onSubmit:i}){var o,l;const{register:a,handleSubmit:t,formState:{errors:n}}=X({mode:"onTouched",resolver:ce(Fi)});return r("form",{onSubmit:t(i),children:s(g,{direction:"column",gap:"16",children:[r(P,c({type:"text",label:"Email",placeholder:"example@gmail.com",error:(o=n.email)==null?void 0:o.message,required:!0},a("email"))),r(P,c({type:"password",label:"Password",error:(l=n.password)==null?void 0:l.message,required:!0},a("password"))),r(U,{type:"submit",loading:e,children:"Sign up"})]})})}function Mi(){const e=G(),[i,{loading:a,error:t}]=ai({onError:n=>console.error(n),onCompleted:()=>e("/")});return s(E,{children:[r(x,{as:"h1",size:"32",children:"Sign up"}),t&&s(F,{children:["Error: ",t.message]}),r(Pi,{loading:a,onSubmit:({email:n,password:o})=>i({variables:{input:{email:n,password:o}}})})]})}function ie(){return r(E,{children:r("p",{children:"Loading..."})})}const Ni=d.ul`
  margin-left: 2rem;
...
`;function Oi({name:e}){const{characterId:i}=q();return i?s(g,{forwardedAs:"nav",gap:"8",px:"16",mx:"auto",children:[r(_e,{size:"24",to:"/characters",children:"Characters"}),r(x,{size:"24",children:"/"}),r(_e,{size:"24",to:`/characters/${i}`,children:e!=null?e:"Loading..."})]}):null}const ji=d(g).attrs({forwardedAs:"nav",mx:"auto"})`
...
`,Xi=d.select`
  ...
  line-height: inherit;
  text-decoration: inherit;
`,Ae=se.forwardRef((h,l)=>{var m=h,{name:e,label:i,error:a,required:t=!1,children:n}=m,o=_(m,["name","label","error","required","children"]);return s(Ki,{children:[r(ue,{htmlFor:e,required:t,children:i}),a&&r(Ji,{children:a}),r(Xi,S(c({id:e,name:e,"aria-label":i,"aria-required":t,$error:!!a,ref:l},o),{children:n}))]})});function Ie({name:e,loading:i,onReset:a}){return s(g,{alignItems:"center",children:[r(x,{as:"h1",size:"32",children:e}),s($e,{justifyContent:"flex-end",gap:"4",children:[r(U,{type:"submit",loading:i,children:"Save"}),r(U,{variant:"secondary",onClick:a,children:"Reset"})]})]})}const Le=d(g).attrs({forwardedAs:"section",direction:"column",gap:"16",flexGrow:1})`
  width: auto;
`,Zi=le().shape({name:W(),level:Ne().typeError("Level must be between 1 and 20").integer("Level must be between 1 and 20").strict().min(1,"Level must be between 1 and 20").max(20,"Level must be between 1 and 20")});function er({name:e,level:i,alignmentId:a,background:t,traits:n,ideals:o,bonds:l,flaws:h,alignments:m,loading:y,onCancel:w,onSubmit:u}){var R,T,k,f,$,I,M,N;const{register:b,handleSubmit:D,formState:{errors:p}}=X({mode:"onTouched",defaultValues:{name:e,level:i,alignmentId:a,background:t,traits:n,ideals:o,bonds:l,flaws:h},resolver:ce(Zi)});return r("form",{onSubmit:D(u),children:s(g,{direction:"column",gap:"16",children:[r(Ie,{name:"Details",loading:y,onReset:w}),s(g,{wrap:"wrap",gap:"16",justifyContent:"center",children:[s(Le,{children:[r(P,c({type:"text",label:"Name",placeholder:"Untitled",error:(R=p.name)==null?void 0:R.message},b("name"))),r(P,c({type:"number",label:"Level",error:(T=p.level)==null?void 0:T.message},b("level",{valueAsNumber:!0}))),r(P,c({type:"text",label:"Background",placeholder:"Acolyte",error:(k=p.background)==null?void 0:k.message},b("background"))),s(Ae,S(c({label:"Alignment",error:(f=p.alignmentId)==null?void 0:f.message},b("alignmentId")),{children:[r("option",{value:"",selected:!0,disabled:!0}),m.map(({id:H,name:O})=>r("option",{value:H,children:O},H))]}))]}),s(Le,{children:[r(re,c({label:"Personality traits",error:($=p.traits)==null?void 0:$.message},b("traits"))),r(re,c({label:"Ideals",error:(I=p.ideals)==null?void 0:I.message},b("ideals"))),r(re,c({label:"Bonds",error:(M=p.bonds)==null?void 0:M.message},b("bonds"))),r(re,c({label:"Flaws",error:(N=p.flaws)==null?void 0:N.message},b("flaws")))]})]})]})})}function ir(){var b,D,p,R,T,k,f;const e=G(),{characterId:i}=q(),{data:a,loading:t,error:n}=Z({variables:{id:String(i)}}),{data:o,loading:l,error:h}=oi(),[m,{loading:y,error:w}]=be({onError:$=>console.error($)});if(n||h||!(a==null?void 0:a.character)||!o)return r(V,{message:n==null?void 0:n.message});const{character:u}=a;return s(E,{children:[w&&r(F,{children:w.message}),r(er,{name:u.name,level:u.level,alignmentId:(D=(b=u.alignment)==null?void 0:b.id)!=null?D:"",background:(p=u.background)!=null?p:"",traits:(R=u.traits)!=null?R:"",ideals:(T=u.ideals)!=null?T:"",bonds:(k=u.bonds)!=null?k:"",flaws:(f=u.flaws)!=null?f:"",alignments:o.alignments,loading:y,onCancel:()=>e(`/characters/${i}`),onSubmit:({name:$,level:I,background:M,alignmentId:N,traits:H,ideals:O,bonds:ne,flaws:te})=>{m({variables:{input:{id:String(i),name:$||void 0,level:I||void 0,background:M||void 0,alignmentId:N||void 0,traits:H||void 0,ideals:O||void 0,bonds:ne||void 0,flaws:te||void 0}}}),e(`/characters/${i}`)}})]})}const rr=d.ul`
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  justify-content: space-between;
...
`,tr=d.h3`
  font-size: 24px;
  line-height: 32px;
`;function or({ability:e}){const{id:i,name:a,score:t,modifier:n}=e;return s(ar,{children:[r(nr,{children:a.slice(0,3)}),s(tr,{children:[n>=0?"+":"-",n]}),r("span",{children:t})]},i)}function sr({abilities:e}){return s(g,{as:"section",direction:"column",gap:"16",children:[r(x,{as:"h3",weight:"600",children:"Abilities"}),r(rr,{children:e.map(i=>r(or,{ability:i}))})]})}const lr=d.ul`
  margin-left: 1.5rem;
`,cr=d.li`
